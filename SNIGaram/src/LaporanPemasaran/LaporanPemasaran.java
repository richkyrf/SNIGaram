 ...
 * @author richk
 */
public class LaporanPemasaran extends javax.swing.JFrame {

    /**
     * Creates new form LaporanLab
     */
    public LaporanPemasaran(String type) {
        initComponents();
        setTitle(type);
        setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanPemasaran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaporanPemasaran("").setVisible(true);
            }
        });
    }
