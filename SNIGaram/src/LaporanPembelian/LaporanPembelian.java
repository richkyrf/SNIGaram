...
import LaporanPemasaran.*;
import LaporanPersonalia.*;
...
public class LaporanPembelian extends javax.swing.JFrame {
     ...
     */
    public LaporanPembelian(String type) {
        initComponents();
        setTitle(type);
        setVisible(true);
        ...
        setResizable(false);
        if (type.equals("Laporan Daftar Supplier") || type.equals("Laporan Daftar Supplier Terpilih")) {
    ...
    private void jbuttonF1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbuttonF1ActionPerformed
        ...
        if (getTitle().equals("Laporan Permintaan Barang")) {
            fLaporan.setfilename("Monic/Pembelian/F 07.01.00.01 Permintaan Barang");
            History.simpanhistory(GlobalVar.VarL.username, "F 07.01.00.01 Permintaan Barang");
        } else if (getTitle().equals("Laporan Surat Permintaan Penawaran")) {
            fLaporan.setfilename("Monic/Pembelian/F 07.01.00.02 Surat Permintaan Penawaran");
            History.simpanhistory(GlobalVar.VarL.username, "F 07.01.00.02 Surat Permintaan Penawaran");
        } else if (getTitle().equals("Laporan Pemesanan")) {
            fLaporan.setfilename("Monic/Pembelian/F 07.01.00.03 Pemesanan");
            History.simpanhistory(GlobalVar.VarL.username, "F 07.01.00.03 Pemesanan");
        } else if (getTitle().equals("Laporan Daftar Supplier")) {
            fLaporan.setfilename("Monic/Pembelian/F 07.01.00.04 Daftar Supplier");
            History.simpanhistory(GlobalVar.VarL.username, "F 07.01.00.04 Daftar Supplier");
        } else if (getTitle().equals("Laporan Daftar Supplier Terpilih")) {
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        if (getTitle().equals("Laporan Permintaan Barang")) {
            laporanPermintaanBarang = null;
        } else if (getTitle().equals("Laporan Surat Permintaan Penawaran")) {
            laporanSuratPermintaanPenawaran = null;
        } else if (getTitle().equals("Laporan Pemesanan")) {
            laporanPemesanan = null;
        } else if (getTitle().equals("Laporan Daftar Supplier")) {
            laporanDaftarSupplier = null;
        } else if (getTitle().equals("Laporan Daftar Supplier Terpilih")) {
            laporanDaftarSupplierTerpilih = null;
        } else if (getTitle().equals("Laporan Penerimaan Barang")) {
            laporanPenerimaanBarang = null;
        } else {
            System.out.println("Parameter Salah");
        }
