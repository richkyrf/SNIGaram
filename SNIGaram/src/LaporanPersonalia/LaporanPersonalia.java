 ...
 * @author richk
 */
public class LaporanPersonalia extends javax.swing.JFrame {

    /**
     * Creates new form LaporanLab
     */
    public LaporanPersonalia(String type) {
        initComponents();
        setTitle(type);
        setVisible(true);
    ...
    private void jbuttonF1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbuttonF1ActionPerformed
        ...
        if (getTitle().equals("Laporan Kebutuhan Karyawan")) {
            fLaporan.setfilename("Arsad/Personalia/F 06.01.00.01 Kebutuhan Karyawan");
            History.simpanhistory(GlobalVar.VarL.username, "F 06.01.00.01 Kebutuhan Karyawan");
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanPersonalia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaporanPersonalia("").setVisible(true);
            }
        });
    }
